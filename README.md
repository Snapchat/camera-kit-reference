...
This repository contains [documentation](./docs) as well as [sample applications](./samples) demonstrating how to integrate the 1.45.0 version of the [Camera Kit](https://kit.snapchat.com/camera-kit) SDK.
