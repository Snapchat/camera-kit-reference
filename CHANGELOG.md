...
### Updates
- **iOS:** Support for ray tracing
- **iOS:** Performance improvements
- **Android:** Android target version updated to 36
...
### Updates
- **iOS:** New API to remove lens by ID
- **Android:** A Lens WarmUp API to preload a lens without rendering it

### Bug Fixes
- **Android:** Fixed an issue that allowed Surfaces usage after the Session had been released in Camera Kit
...
### Updates
- **iOS:** Removed base extension
- **iOS:** A new Lens Prefetch API, which will enable the customization of priorities for preloading lens content
- **iOS:** A Lens WarmUp API to preload a lens without rendering it

### Bug Fixes
- **iOS:** Fixed potential race condition for ToS prompt
- **Android:** Fixed memory leak related to lens keyboard
